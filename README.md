...
As at 20250613:YYYYMMDD, the .ESD file can not be seen or selected in the Windows Image pane found in the bottom left of the Windows System Image Manager, but you can rename the .ESD file to .WIM and can then select the ```install.wim``` file to work with in the Windows System Image Manager.
