...
The minimum configuration for ```AutoUnattend.xml``` to install Windows Desktop using components, without user input using a USB mem stick aka a fully automated installation of windows. 
...
| [windowsPE](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/windowsPE.md) | [Microsoft-Windows-Setup](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-Setup.md) | [UserData](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-Setup.md#userdata) | This is the section where you specify the user settings to install the version of windows. |
| [windowsPE](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/windowsPE.md) | [Microsoft-Windows-Setup](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-Setup.md) | [UseConfigurationSet](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-Setup.md#useconfigurationset) | UseConfigurationSet specifies whether to use a configuration set for Windows Setup. |
...
| [windowsPE](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/windowsPE.md) | [Microsoft-Windows-PnpCustomizationsWinPE](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-PnpCustomizationsWinPE.md) | [Path](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-PnpCustomizationsWinPE.md#path) | This is the first opportunity in the autounattend.xml process where you can create the ```$WinpeDriver$``` folder and subfolders containing drivers on the memory stick for installation during the windowsPE pass and other passes in the autounattend.xml. |
(https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-PnpCustomizationsWinPE.md) | [Microsoft-Windows-PnpCustomizationsWinPE](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-PnpCustomizationsWinPE.md) | [Credentials](https://github.com/Intelligent-Silicon/AutoUnattend/blob/main/Microsoft-Windows-PnpCustomizationsWinPE.md#credentials) | |
