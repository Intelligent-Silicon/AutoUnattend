...
There are a few different ways to install Windows. The finished AutoUnattend.xml file is included to the root folder of the Media Creation Tool USB memory stick or ISO image file, before burning to DVD where applicable.
