...
```
	...
	You can copy, move and duplicate virtual pc's easily for lab's, testing and production becuase virtual pc's are typically a handful of files that run through the virtualisation software.
```
