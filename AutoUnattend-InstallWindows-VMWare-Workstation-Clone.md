...
Windows 10 Common Core + Foundation Package (Version Features to make versions like Home, Education Pro, Pro N) + Enablement Package (22H2) + Various Types of Updates.
