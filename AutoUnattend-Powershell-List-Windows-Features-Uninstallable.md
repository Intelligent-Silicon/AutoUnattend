...
| IIS-WebServer | Disabled | Disabled | Disabled | The IIS 7 and later web servers have a completely modular architecture which offers three key benefits: Componentization, Extensibility, ASP.NET Integration
