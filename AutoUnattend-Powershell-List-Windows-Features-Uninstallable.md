...
| WCF-HTTP-Activation | Disabled | Disabled | Disabled | The Windows Process Activation Service (WAS) to allow common hosting within IIS regardless of the communications protocol being used. You can host your net.tcp WCF services on IIS and they will be dynamically activated once traffic starts arriving. | [Microsoft.com](https://learn.microsoft.com/en-us/archive/msdn-magazine/2007/september/iis-7-0-extend-your-wcf-services-beyond-http-with-was) |
