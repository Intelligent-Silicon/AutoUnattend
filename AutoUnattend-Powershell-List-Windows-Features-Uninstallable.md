...
| SMB1Protocol-Deprecation | Disabled | Disabled | The SMB1Protocol-Deprecation feature refers to the process of removing or disabling the SMB1 (Server Message Block version 1) protocol in Windows operating systems and other systems that previously relied on it. SMB1 is considered a legacy protocol with known security vulnerabilities (Ransomware) and performance limitations, and its removal is part of a broader effort to enhance security and efficiency by encouraging the use of newer SMB versions. [NHS Ransomware](https://digital.nhs.uk/cyber-alerts/2017/cc-1411) [Maersk](https://gvnshtn.com/posts/maersk-me-notpetya/) | [Microsoft.com](https://learn.microsoft.com/en-us/windows-server/storage/file-server/troubleshoot/smbv1-not-installed-by-default-in-windows) |
