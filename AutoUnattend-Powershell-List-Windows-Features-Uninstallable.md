...
| NetFx4-AdvSrvs | Enabled | Disabled | Disabled | The "NetFx4-AdvSrvs" feature refers to the ".NET Framework 4 Advanced Services" optional feature within Windows operating systems. It is a component of the .NET Framework 4 and later versions, providing a collection of services and functionalities used by applications. | [Microsoft.com](https://learn.microsoft.com/en-us/dotnet/framework/install/how-to-determine-which-versions-are-installed#net-framework-45-and-later-versions) |
| NetFx4Extended-ASPNET45 | Disabled | Disabled | Disabled | The NetFx4Extended-ASPNET45 feature refers to a specific Windows feature related to ASP.NET 4.5, which is part of the .NET Framework 4.5 Extended. It is essentially the ASP.NET component of the .NET Framework that needs to be enabled when installing or configuring ASP.NET 4.5 on a Windows system, especially when using Visual Studio. | [Microsoft.com](https://learn.microsoft.com/en-us/troubleshoot/developer/webapps/aspnet/configuration/install-aspnet-45-windows-8-server-2012) |
| SMB1Protocol | Disabled | Disabled | Disabled | SMB1 (Server Message Block version 1) is an outdated and insecure file-sharing protocol that was initially developed for DOS and later adopted by Microsoft for its Windows operating systems. While it allowed for basic file sharing, printer access, and remote service requests, SMB1's security weaknesses make it vulnerable to cyberattacks. Modern Windows versions no longer install SMB1 by default, and it's recommended to disable it if it's enabled and not needed for legacy compatibility. | [Microsoft.com](https://learn.microsoft.com/en-us/windows-server/storage/file-server/troubleshoot/detect-enable-and-disable-smbv1-v2-v3?tabs=server) |
| SMB1Protocol-Client | Disabled | Disabled | Disabled | The SMB1Protocol-Client feature in Windows allows computers to access files and resources on older servers that only support the Server Message Block version 1 (SMB1) protocol. While SMB1 was once the standard for file sharing, it is now deprecated due to security vulnerabilities. Modern Windows versions no longer include SMB1 by default, but it can be enabled as a feature if necessary. | [Microsoft.com](https://learn.microsoft.com/en-us/windows-server/storage/file-server/troubleshoot/smbv1-not-installed-by-default-in-windows) |
| SMB1Protocol-Server | Disabled | Disabled | Disabled | SMB1 (Server Message Block version 1) is an older file sharing protocol that is disabled by default in modern Windows and Windows Server versions due to security vulnerabilities. It was initially developed for DOS in the early 1980s and later became a core part of Windows networking. While SMB1 enabled file and printer sharing, its vulnerabilities make it a potential security risk. Modern versions of Windows use SMB2 and SMB3, which offer enhanced security and performance. | [Microsoft.com](https://learn.microsoft.com/en-us/windows-server/storage/file-server/troubleshoot/smbv1-not-installed-by-default-in-windows) |
| Recall | Disabled* | Disabled* | Disabled* | Disabled* = DisabledWithPayloadRemoved Recall is a feature available on Copilot+ PCs that allows users to search their past activity using natural language, essentially acting as a "photographic memory" for their computer. It works by periodically taking snapshots of the screen and making them searchable using AI. This enables users to find content they've previously viewed, including text, images, and even specific actions within applications and website. | [Microsoft.com](https://support.microsoft.com/en-us/windows/privacy-and-control-over-your-recall-experience-d404f672-7647-41e5-886c-a3c59680af15) |
| HypervisorPlatform | Enabled | Disabled | Disabled | The Hypervisor Platform feature in Windows refers to an API that allows third-party virtualization software like Docker, VMware, and VirtualBox to utilize the underlying Hyper-V virtualization infrastructure. It enables these applications to interact with and leverage the Hyper-V hypervisor for creating and managing virtual machines, enhancing their functionality and performance. | [Microsoft.com](https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/get-started/install-hyper-v?tabs=powershell&pivots=windows) |
| Microsoft-Windows-Subsystem-Linux | Disabled | Disabled | Disabled | The "Microsoft-Windows-Subsystem-Linux" feature in Windows allows users to run a Linux environment directly on Windows, without needing a virtual machine or dual-boot setup. This feature, known as the Windows Subsystem for Linux (WSL), enables developers and users to utilize Linux command-line tools, utilities, and applications alongside their Windows environment. | [Microsoft.com](https://learn.microsoft.com/en-us/windows/wsl/about) |
