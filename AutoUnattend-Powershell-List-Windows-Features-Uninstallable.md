...
| IIS-WebServer | Disabled | Disabled | Disabled | IIS (Internet Information Services) is a flexible, general-purpose web server for Windows systems, offering features for hosting websites, web applications, and services. The IIS 7 and later web servers have a completely modular architecture which offers three key benefits: Componentization, Extensibility, ASP.NET Integration
 | [Microsoft.com](https://learn.microsoft.com/en-us/iis/get-started/introduction-to-iis/iis-web-server-overview) |
