...
| WCF-NonHTTP-Activation | Disabled | Disabled | Disabled | As above where WCF Non-HTTP Activation refers to the ability of Windows Communication Foundation (WCF) services to be activated and hosted using protocols other than HTTP, such as TCP or Named Pipes. | |
